...
export const paystackWebhook = async (
  ...
  try {
    ...
    if (
      ...
      const usedLaunchPlan =
        event.data.plan?.plan_code === process.env.PAYSTACK_PLAN_CODE_LAUNCH;
      ...
      await User.findByIdAndUpdate(
        userId,
        {
          ...
          // once true, always true — see startSubscription for why
          ...(usedLaunchPlan ? { usedLaunchOffer: true } : {})
        }
      );
    }
